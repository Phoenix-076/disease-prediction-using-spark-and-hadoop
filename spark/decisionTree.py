...
df = spark.read.csv("hdfs://namenode:8020/data/Training.csv", header=True, inferSchema=True)
df.printSchema()
...
test_df = spark.read.csv("hdfs://namenode:8020/data/Testing.csv", header=True, inferSchema=True)
print("\nSchema for test df: ")
test_df.printSchema()
